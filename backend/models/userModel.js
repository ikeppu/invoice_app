...
const userSchema = new Schema(
  {
    ...
    password: {
      ...
      validate: [
        ...
        "Password must be at least 8 characters length lon, with at least 1 uppercase and lowercase letters and at least 1 symbol",
      ],
    },
    passwordComfirm: {
      type: String,
    ...
    phoneNumber: {
      ...
      validate: [
        ...
        "Your mobile phone number must begin with a '+', followed by your country code then actual number",
      ],
    },
    address: String,
    city: String,
